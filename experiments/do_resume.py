...
parser = argparse.ArgumentParser(description='Join all pictures into one to create an overview resume')
...
def draw_at_temp(temp, name_data, epochs_to_plot, save_path, descriptor):
    ...
    for index, file in enumerate(files):
        ...
        if desc_to_plot == 'FractionCSP3': name_='Fsp3'
        else: name_=desc_to_plot
